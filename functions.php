...
function wpbb_travel_after_hero_finder( $content, $profile ) {
    if ( ( $profile['id'] ?? '' ) !== 'travel' ) return $content;
    return $content . '<!-- wp:wpbb/bootstrap-div {"containerClass":"","utilityClasses":"wp-theme-section-shell wpbb-travel-finder-section","className":"wpbb-v62-section"} --><!-- wp:wpbb/row {"containerClass":"container"} --><!-- wp:wpbb/column {"xs":12} --><!-- wp:wpbb/sector-finder {"context":"travel","limit":8} /--><!-- /wp:wpbb/column --><!-- /wp:wpbb/row --><!-- /wp:wpbb/bootstrap-div -->';
}
...
// v3.8.11.37 canonical 1320px section alignment, unified grids and section media quality.
